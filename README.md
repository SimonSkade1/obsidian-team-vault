...
2. **Seven properties**, written by the **New** button when you create a file (see *Creating items*):
	...
	2. `priority` — 1–10, **10 = most important**, empty counts as 5; sorts within a section, highest first; a project also counts as the highest priority set on anything below it (empty ones below don't count).
